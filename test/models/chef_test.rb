...
class ChefTest < ActiveSupport::TestCase
  def setup
    @chef=Chef.new(chefname:"John", email: "chef@chef.com")
  end
  ...
  test "email addres should bu unique" do
    dup_chef = @chef.dup
  ...
  test "email validation should reject invalid addresses" do
    invalid_addresses = %w[user@example,com user_at_eee.org user.name@example. eee@i_am.com foo@eee+arr.com]
